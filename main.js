...
import Pino from 'pino'
import { LuBotJadiBot } from './plugins/jadibot-serbot.js'
...
LuBotJadiBot({pathLuBotJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}
}
}
}
